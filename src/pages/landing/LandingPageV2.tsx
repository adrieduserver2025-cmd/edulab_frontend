...
const scholarshipCarouselItems = [
  ...
  },
  {
    id: "mext-japon",
    type: "Beca de Gobierno",
    title: "Beca MEXT Japón (Pregrado)",
    country: "Japón",
    flag: "🇯🇵",
    desc: "100% financiada por el Gobierno de Japón con 1 año intensivo de idioma japonés + 4 años de carrera universitaria.",
    specs: [{ label: "Estipendio", val: "100% Manutención + Pasajes" }, { label: "Idioma", val: "Japonés / Inglés" }, { label: "Nivel", val: "Pregrado (5 años)" }],
    route: "/becas/mext-japon-beca",
    image: "https://images.unsplash.com/photo-1503899036084-c55cdd92da26?w=800&auto=format&fit=crop&q=80",
    badgeColor: "bg-red-50 text-red-700 border border-red-200"
  },
  {
    id: "turkiye-burslari",
    type: "Beca Estatal YTB",
    title: "Beca Türkiye Burslari",
    country: "Turquía",
    flag: "🇹🇷",
    desc: "Colocación universitaria automática, residencia gratuita, 1 año de turco gratis y estipendio mensual en Turquía.",
    specs: [{ label: "Estipendio", val: "4.500 - 9.000 TL/mes" }, { label: "Idioma", val: "Turco / Inglés" }, { label: "Nivel", val: "Pregrado & Posgrado" }],
    route: "/becas/turkiye-burslari-beca",
  ...
  },
  {
    ...
    type: "Beca Estatal UE",
    title: "Stipendium Hungaricum",
    country: "Hungría",
    flag: "🇭🇺",
    desc: "Elegible para Bolivia vía SEGIB en 30+ universidades húngaras con 900+ programas dictados en inglés.",
    specs: [{ label: "Estipendio", val: "Completo + Alojamiento" }, { label: "Idioma", val: "Inglés B2" }, { label: "Nivel", val: "Licenciatura / Posgrado" }],
    route: "/becas/stipendium-hungaricum-beca",
    image: "https://images.unsplash.com/photo-1516550893923-42d28e5677af?w=800&auto=format&fit=crop&q=80",
    badgeColor: "bg-emerald-50 text-emerald-700 border border-emerald-200"
  },
  {
    id: "chevening-uk",
    type: "Beca de Élite FCDO",
    title: "Chevening Scholarships UK",
    country: "Reino Unido",
    flag: "🇬🇧",
    desc: "Maestría de 1 año 100% financiada en cualquier universidad del Reino Unido con estipendio hasta £1.690/mes y visa.",
    specs: [{ label: "Estipendio", val: "£1.378 - £1.690/mes" }, { label: "Idioma", val: "Inglés C1" }, { label: "Nivel", val: "Maestría (1 año)" }],
    route: "/becas/chevening-uk-beca",
    image: "https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?w=800&auto=format&fit=crop&q=80",
    badgeColor: "bg-purple-50 text-purple-700 border border-purple-200"
  },
  {
    id: "oea-gcub",
    type: "Movilidad Académica OEA",
    title: "Beca OEA - GCUB Brasil",
    country: "Brasil",
    flag: "🇧🇷",
    desc: "Exención total de matrícula y mensualidad en 50+ universidades de Brasil para maestrías y posgrados.",
    specs: [{ label: "Estipendio", val: "100% Matrícula + Mensualidad" }, { label: "Idioma", val: "Portugués / Español" }, { label: "Nivel", val: "Maestría & Doctorado" }],
    route: "/becas/oea-gcub-brasil-beca",
  ...
  {
    id: "swedish-siss",
    type: "Beca Instituto Sueco",
    title: "SI Scholarships Suecia (SISS)",
    country: "Suecia",
    flag: "🇸🇪",
    desc: "Maestrías en Suecia con 11.000 SEK/mes de estipendio, pasajes y matrícula totalmente cubierta.",
    specs: [{ label: "Estipendio", val: "11.000 SEK/mes" }, { label: "Idioma", val: "Inglés C1" }, { label: "Nivel", val: "Maestría (1-2 años)" }],
    route: "/becas/swedish-institute-siss-beca",
  ...
  {
    id: "ares-belgica",
    type: "Especialización ARES",
    title: "Becas ARES Bélgica",
    country: "Bélgica",
    flag: "🇧🇪",
    desc: "Maestrías de especialización totalmente financiadas en salud pública, riesgos y desarrollo en la Bélgica francófona.",
    specs: [{ label: "Estipendio", val: "100% Completo + Vuelos" }, { label: "Idioma", val: "Francés / Inglés" }, { label: "Nivel", val: "Especialización (1 año)" }],
    route: "/becas/ares-belgica-beca",
    image: "https://images.unsplash.com/photo-1513581166391-887a96ddeafd?w=800&auto=format&fit=crop&q=80",
    badgeColor: "bg-yellow-50 text-yellow-800 border border-yellow-200"
  },
  {
    id: "daad-investigacion",
    type: "Estancia Doctoral DAAD",
    title: "DAAD Investigación Alemania",
    country: "Alemania",
    flag: "🇩🇪",
    desc: "Estancias de investigación de 1 a 6 meses financiadas al 100% en universidades e institutos alemanes.",
    specs: [{ label: "Estipendio", val: "934 € - 1.200 €/mes" }, { label: "Idioma", val: "Inglés / Alemán" }, { label: "Nivel", val: "Doctorado & PhD" }],
    route: "/becas/daad-investigacion-beca",
  ...
  },
  {
    ...
    type: "Beca Postdoctoral",
    title: "Humboldt Research Fellowship",
    country: "Alemania",
    flag: "🇩🇪",
    desc: "Financiamiento de 2.600 € a 3.100 €/mes + apoyo familiar para investigación postdoctoral autónoma en Alemania.",
    specs: [{ label: "Estipendio", val: "2.600 € - 3.100 €/mes" }, { label: "Idioma", val: "Inglés / Alemán" }, { label: "Nivel", val: "Postdoc (6-24m)" }],
    route: "/becas/humboldt-research-beca",
    image: "https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=800&auto=format&fit=crop&q=80",
    badgeColor: "bg-amber-50 text-amber-800 border border-amber-200"
  },
  {
    id: "fulbright-visiting",
    type: "Beca de Investigación",
    title: "Fulbright Visiting Scholar",
    country: "Estados Unidos",
    flag: "🇺🇸",
    desc: "Investigación avanzada de 3 a 9 meses en universidades de EE.UU. para docentes e investigadores bolivianos.",
    specs: [{ label: "Estipendio", val: "Manutención + Vuelos" }, { label: "Idioma", val: "Inglés (TOEFL)" }, { label: "Nivel", val: "Investigación / PhD" }],
    route: "/becas/fulbright-visiting-scholar-beca",
    image: "https://images.unsplash.com/photo-1501504905252-473c47e087f8?w=800&auto=format&fit=crop&q=80",
    badgeColor: "bg-cyan-50 text-cyan-700 border border-cyan-200"
  },
  {
    id: "suiza-research",
    type: "Beca Gobierno Suizo",
    title: "Gobierno Suizo Research",
    country: "Suiza",
    flag: "🇨🇭",
    desc: "Estancias de investigación de posgrado con 1.920 CHF/mes en institutos de física, química y salud en Suiza.",
    specs: [{ label: "Estipendio", val: "1.920 CHF / mes" }, { label: "Idioma", val: "Inglés / Francés" }, { label: "Nivel", val: "Posgrado <35 años" }],
    route: "/becas/suiza-research-fellowship-beca",
    image: "https://images.unsplash.com/photo-1530122037265-a5f1f91d3b99?w=800&auto=format&fit=crop&q=80",
    badgeColor: "bg-red-50 text-red-700 border border-red-200"
  },
  {
    id: "twas-desarrollo",
    type: "Beca Sur Global",
    title: "Becas TWAS (Brasil / Sur Global)",
    country: "Brasil",
    flag: "🇧🇷",
    desc: "Estancias de 3 a 12 meses para doctorandos y PhDs jóvenes en ciencias naturales con 100% financiamiento.",
    specs: [{ label: "Estipendio", val: "Manutención + Vuelos" }, { label: "Idioma", val: "Inglés / Portugués" }, { label: "Nivel", val: "Doctorado & Postdoc" }],
    route: "/becas/twas-desarrollo-beca",
    image: "https://images.unsplash.com/photo-1532094349884-543bc11b234d?w=800&auto=format&fit=crop&q=80",
    badgeColor: "bg-emerald-50 text-emerald-700 border border-emerald-200"
  },
  {
    id: "elap-canada",
    type: "Intercambio EduCanada",
    title: "ELAP Canadá (Líderes Emergentes)",
    country: "Canadá",
    flag: "🇨🇦",
    desc: "Intercambios de 4 a 6 meses financiados con 8.200 a 11.100 CAD en universidades líderes de Canadá.",
    specs: [{ label: "Estipendio", val: "8.200 - 11.100 CAD" }, { label: "Idioma", val: "Inglés / Francés" }, { label: "Nivel", val: "Pregrado & Posgrado" }],
    route: "/becas/elap-canada-beca",
    image: "https://images.unsplash.com/photo-1517935703635-27c735286572?w=800&auto=format&fit=crop&q=80",
    badgeColor: "bg-rose-50 text-rose-700 border border-rose-200"
  },
  {
    id: "susi-eeuu",
    type: "Inmersión EE.UU.",
    title: "Programa SUSI EE.UU.",
    country: "Estados Unidos",
    flag: "🇺🇸",
    desc: "Seminarios académicos intensivos de 5 a 6 semanas en EE.UU. con financiamiento 100% para líderes jóvenes.",
    specs: [{ label: "Estipendio", val: "100% Financiado + Vuelos" }, { label: "Idioma", val: "Inglés / Español" }, { label: "Nivel", val: "Jóvenes 18-25 años" }],
    route: "/becas/susi-eeuu-beca",
    image: "https://images.unsplash.com/photo-1541339907198-e08756dedf3f?w=800&auto=format&fit=crop&q=80",
    badgeColor: "bg-indigo-50 text-indigo-700 border border-indigo-200"
  },
  {
    id: "oea-cursos",
    type: "Capacitación OEA",
    title: "OEA Cursos Cortos Profesional",
    country: "Américas",
    flag: "🌎",
    desc: "Cursos de 1 semana a 3 meses presenciales y online en gobernabilidad, sostenibilidad y tecnología.",
    specs: [{ label: "Estipendio", val: "100% Matrícula" }, { label: "Idioma", val: "Español / Inglés" }, { label: "Nivel", val: "Profesionales" }],
    route: "/becas/oea-cursos-desarrollo-beca",
    image: "https://images.unsplash.com/photo-1524178232363-1fb2b075b655?w=800&auto=format&fit=crop&q=80",
    badgeColor: "bg-blue-50 text-blue-700 border border-blue-200"
  },
  {
    id: "politecnico-milano",
    type: "Beca Mérito POLIMI",
    title: "Politécnico de Milán",
    country: "Italia",
    flag: "🇮🇹",
    desc: "Becas de excelencia para maestrías en Ingeniería, Arquitectura y Diseño con exención de matrícula + 10.000 €/año.",
    specs: [{ label: "Estipendio", val: "Exención + 10.000 €/año" }, { label: "Idioma", val: "Inglés C1" }, { label: "Nivel", val: "Maestría (2 años)" }],
    route: "/becas/politecnico-milano-beca",
    image: "https://images.unsplash.com/photo-1513581166391-887a96ddeafd?w=800&auto=format&fit=crop&q=80",
    badgeColor: "bg-emerald-50 text-emerald-700 border border-emerald-200"
  }
];
