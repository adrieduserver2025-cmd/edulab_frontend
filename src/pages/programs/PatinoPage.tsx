...
const PATINO_HERO_SLIDES = [
  { url: unigePhoto, title: "Université de Genève · Suiza" },
  { url: patinoPhoto1, title: "Universidad de Ginebra & Lausanne · Suiza" },
  { url: patinoPhoto2, title: "Becarios Fundación Simón I. Patiño · Suiza" },
  { url: patinoPhoto4, title: "Sede Fundación Simón I. Patiño · Ginebra" }
];
...
export default function PatinoPage() {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setCurrentSlideIdx((prev) => (prev + 1) % PATINO_HERO_SLIDES.length);
    }, 5000);
    ...
    <div className="min-h-screen bg-white font-sans text-slate-900" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <section className="hero-pattern pt-28 pb-16 relative overflow-hidden text-white min-h-[580px] flex items-center">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none">
          {PATINO_HERO_SLIDES.map((slide, idx) => (
            <div
              key={idx}
        ...
        <div className="absolute bottom-6 right-8 z-20 hidden md:flex items-center gap-3 bg-black/60 backdrop-blur-md border border-white/20 px-4 py-2 rounded-full text-xs font-medium text-white shadow-xl">
          <span className="text-white/90 font-semibold">{PATINO_HERO_SLIDES[currentSlideIdx].title}</span>
          <div className="flex gap-1.5 ml-2">
            {PATINO_HERO_SLIDES.map((_, idx) => (
              <button
                key={idx}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-7 text-left drop-shadow-md">
              ...
              <p className="text-white/95 text-base sm:text-lg leading-relaxed max-w-xl font-medium drop-shadow-md">
                Estudia una maestría de excelencia en las universidades más prestigiosas de <strong className="text-white font-black underline decoration-[#F5C542]">Suiza y Bélgica</strong> con financiamiento 100% integral.
              </p>
            ...
            <div className="lg:col-span-5 flex justify-center lg:justify-end">
              ...
              >
                ...
                <div className="w-full max-w-[280px] h-24 mx-auto rounded-2xl bg-white p-3 shadow-2xl flex items-center justify-center border-2 border-[#F5C542] transition-transform hover:scale-105 duration-300">
                  <img
                    src={patinoLogo}
                    alt="Logo Fundación Simón I. Patiño"
                ...
                <div>
                  <h3 className="text-2xl font-black text-white tracking-tight drop-shadow-md">
                    Fundación <span style={{ color: "#F5C542" }}>Simón I. Patiño</span>
                  </h3>
                  <p className="text-xs text-amber-300 mt-1 font-bold uppercase tracking-wider">
                    Entidad Convocante Oficial · Ginebra, Suiza
                  </p>
                </div>
                ...
                <div className="pt-4 border-t border-white/10 text-xs space-y-2.5 text-left text-white/80">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-bold text-white flex items-center gap-1">🇨🇭 Ginebra, Suiza</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-white/50 font-medium">Entidad Convocante:</span>
                    <span className="font-bold text-white">Fondation Simón I. Patiño</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-white/50 font-medium">Convenios Top:</span>
                    <span className="font-bold text-[#F5C542]">UNIGE, UNIL, EPFL, ULB, BFH</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-white/50 font-medium">Cobertura:</span>
                    <span className="font-bold text-emerald-400">100% Completa (Estipendio + Pasajes)</span>
                  </div>
                </div>
              </div>
            </div>
